/**
 * PublishSuccess Component
 * Full-screen success state after publishing a perk.
 * Mirrors ClaimedSuccess pattern from influencer perk-detail.
 */
  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top + 60 }]}>
      ...
      <Animated.View style={[styles.content, contentStyle]}>
        ...
        {/* Headline */}
        <Text style={styles.headline}>Your perk is live.</Text>

        {/* Subtext */}
        <Text style={styles.subtext}>
          Influencers can start claiming now. You'll be notified when someone
          does.
        </Text>
        ...
        <View style={styles.summaryCard}>
          ...
          <View style={styles.summaryRow}>
            ...
            <Text style={styles.summaryValue}>₪{formData.value}</Text>
          </View>
          <View style={styles.divider} />
          <View style={styles.summaryRow}>
            <Text style={styles.summaryLabel}>Slots</Text>
            <Text style={styles.summaryValue}>
              {formData.maxClaims}/{formData.maxClaims} available
            </Text>
          </View>
        </View>
