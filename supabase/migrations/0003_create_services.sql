...
-- Description: Services offered by influencer for booking
...
-- Influencer can manage their own services
CREATE POLICY "Influencer can insert own services"
...
CREATE POLICY "Influencer can update own services"
...
CREATE POLICY "Influencer can delete own services"
